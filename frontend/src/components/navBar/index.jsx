...
const NavBar = ({
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch("https://research-llm-backend-316797979759.us-east4.run.app/login", {
                method: "POST",
    ...
    const handleRegister = async (e) => {
        ...
        try {
            const response = await fetch("https://research-llm-backend-316797979759.us-east4.run.app/register", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    email: formData.email,
        ...
        <>
            <div className="h-14 flex items-center px-4 border-b border-zinc-800 bg-zinc-900">
                ...
                <div className="ml-auto flex items-center gap-4">
                    ...
                    {localStorage.getItem("token") ? <Link to="/notebook" className="hover:text-gray-200 text-gray-300">
